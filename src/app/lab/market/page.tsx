...
import { ALL_CHEMICALS, type Chemical } from '@/lib/experiment';
...
export default function MarketPage() {
  ...
  const handleAddToInventory = (chemical: Chemical) => {
    ...
    // to update a shared inventory state.
  ...
  const filteredChemicals = ALL_CHEMICALS.filter(chem => 
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 max-w-lg mx-auto">
          <div className="relative">
            ...
            <Input
              type="search"
              placeholder="Search for chemicals by name or formula..."
